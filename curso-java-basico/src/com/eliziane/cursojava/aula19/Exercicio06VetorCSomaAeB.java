...
/*Loiane.training
 * Criar dois vetores de A e B cada um com 10 elementos inteiros. Construir um
 * vetor C, onde cada elemento de C é a soma dos respectivos elementos A e B, 
 * ou seja: C[i] = A[i] + B[i].
 */

import java.util.Scanner;

public class Exercicio06VetorCSomaAeB {
