...
public class Exercicio02Matriz10x10 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < numerosAleatorios[linha5].length; i++) {
			if (numerosAleatorios[linha5][i] > maiorL5) { // linha fixa e coluna variável
		...
		int col7 = 7;
		for (int i = 0; i < numerosAleatorios.length; i++) {
			if (numerosAleatorios[i][col7] > maiorC7) {// linhas variáveis e coluna fixa
